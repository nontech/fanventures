...
export default function Verify() {
  return (
    <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7">Verify</h2>
          ...
          <div>
            <div>Funds Recipient Verification*</div>
            <div>The campaign owner must be verified to launch the campaign. ID verification will be done with a third party.</div>
          ...
          <div>
            ...
            <div className="col-span-full">
              <label htmlFor="account" className="block text-sm font-medium leading-6">
                Fill out your bank account information. Learn more about payouts.  
              </label>
              <div className="mt-2">
                <input
                  type="text"
          ...
          <div>
            ...
            <div>Please upload any financial statements that you have from the past. The more information you provide the more successful your campaign will be.</div>
          </div>
          ...
          <div className="flex">
            ...
            <div>
              ...
              <div>Upload the most current balance sheet.</div>
              <div>Upload Figure</div>
            </div>
            {/* Income Statement */}
            <div>
              <div>Income Statement</div>
              <div>Upload the most current income statement. </div>
              <div>Upload Figure</div>
            </div>
          </div>
